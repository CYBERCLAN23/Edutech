    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0D1B2A]">Créer un compte admin</h1>
          <p className="text-gray-500 mt-1">EduCam AI - Administration</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">Code d'inscription</label>
          ...
          <button type="submit" disabled={loading}
            className="w-full py-3 bg-[#4F46E5] text-white rounded-xl font-medium hover:bg-[#4338CA] transition-colors disabled:opacity-50 mb-3">
            {loading ? 'Création...' : 'Créer le compte'}
          </button>
          <button type="button" onClick={onBack}
            className="w-full py-3 text-gray-500 rounded-xl font-medium hover:bg-gray-50 transition-colors">
